                    ...
                    <tr key={r.vin + r.scanDate + i} className="lg-row" style={{ background: i % 2 ? "#22252B" : "#24272E" }}>
                      ...
                      <td className="lg-mono" style={{ padding: "4px 5px" }}>
                        {(() => {
                          ...
                          const isGreenSubP = pct <= 124;
                          const isYellow = pct >= 125 && pct <= 130;
                          const ltvColor = isGreenSubP ? "#3FA796" : isYellow ? "#F2A93B" : "#C1502E";
                          return (
                            <span style={{ color: ltvColor, fontWeight: 700 }}>
                              {pct}%{isGreenSubP ? " SubP" : ""}
                            </span>
                          );
                        })()}
                      </td>
