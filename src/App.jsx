  ...
  return (
    <div ref={scrollRef} className="lg-scroll" style={{ height: "100vh", overflowY: "auto", overscrollBehavior: "contain", WebkitOverflowScrolling: "touch", background: "#1E2027", color: "#ECE7DC", fontFamily: "'IBM Plex Sans', system-ui, sans-serif" }}>
      <style>{`
        ...
        /* Landscape-only correction: the shorter viewport caused the sticky search
           strip to tuck partly under the black masthead. Portrait is intentionally
           unchanged. */
        @media (orientation: landscape) {
          .lg-search-sticky { top: calc(var(--lg-header-height) + 52px) !important; }
        }
        ...
        {totalCount > 0 && (
          <div>
            ...
            <div className="lg-search-sticky" style={{
              ...
              position: "sticky", top: headerHeight + 32, zIndex: 55,
              // Keep the search/control strip fully below the sticky black banner.
              // The extra 32px preserves the same visual gap it has before scrolling
              // instead of letting the search field slide underneath the banner.
