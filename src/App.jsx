      ...
      <div style={{ padding: "10px 12px 10px 8px", display: "flex", flexDirection: "column", gap: 8 }}>
        ...
        {totalCount > 0 && (
          <div>
            ...
            <div style={{
              position: "sticky", top: headerHeight + 12, zIndex: 55,
              // 12px safety gap keeps the search box fully below the black banner
              // even on mobile browsers that round sticky element heights.
